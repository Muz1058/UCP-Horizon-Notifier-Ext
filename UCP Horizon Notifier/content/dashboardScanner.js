...
(function () {
  ...
  function buildPanel(data) {
    ...
    const TABS = [
      ...
      {key:"mat",label:"Mat",    u:tabU.mat},
      {key:"sub",label:"Sub",    u:tabU.sub},
      {key:"grd",label:"Grades", u:tabU.grd},
  ...
  function parseMaterials(doc, cn, courseId) {
    ...
    for (const tbl of doc.querySelectorAll("table")) {
      ...
      tbl.querySelectorAll("tbody tr").forEach(row => {
        ...
        items.push({ id:makeId("mat",courseId||cn,fn,dl||dc), courseName:cn, courseId:courseId||"", tabLabel:"Course Material",
